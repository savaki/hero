...
main.core.current_request_state = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 3, ["requested-by",main.core.user_id,"status",null,"task-type",null], null));
...
main.core.clear_current_request_BANG_ = (function clear_current_request_BANG_(){cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(main.core.current_request_state,"provider",null);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(main.core.current_request_state,"task-type",null);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(main.core.current_request_state,"status",null);
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(main.core.current_request_state,"feed",cljs.core.PersistentVector.EMPTY);
});
...
return ajax.core.POST.cljs$core$IFn$_invoke$arity$variadic("/api/requests",cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$34,cljs.core.deref(main.core.current_request_state),cljs.core.constant$keyword$38,cljs.core.constant$keyword$85,cljs.core.constant$keyword$36,(function (result){cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([result], 0));
main.core.clear_current_request_BANG_();
...
main.core.task_search_view = (function task_search_view(){return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$91,main.core.page_state_class("hero-task-search"),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [main.core.hero_header_view,"Request Item",main.core.cancel_to_home,main.core.blank], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [main.core.task_item,"new-report"], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [main.core.task_search_contents], null)], null);
});
...
main.core.task_select_item = (function task_select_item(task_type){return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$92,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$64,(function (){return main.core.select_task_type(task_type);
...
return (function (){return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$81,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$93,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$88,"text",cljs.core.constant$keyword$94,((function (val){
return (function (p1__5230_SHARP_){return cljs.core.reset_BANG_(val,p1__5230_SHARP_.target.value);
});})(val))
], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$93,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$88,"button",cljs.core.constant$keyword$95,"Send",cljs.core.constant$keyword$64,((function (val){
