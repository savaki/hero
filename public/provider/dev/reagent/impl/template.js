...
{return (function() { 
var G__5473__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__5476 = res;(G__5476[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__5476;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__5477){var vec__5479 = p__5477;var id = cljs.core.nth.call(null,vec__5479,(0),null);var class$ = cljs.core.nth.call(null,vec__5479,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{if(new cljs.core.Keyword(null,"else","else",-1508377146))
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_5480 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_5480 === "key")))
{(o[pname_5480] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
return (function (p1__5481_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__5481_SHARP_);
...
return (function (p1__5486_SHARP_,p2__5487_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__5486_SHARP_,p2__5487_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__5489 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__5489,(0),null);var id = cljs.core.nth.call(null,vec__5489,(1),null);var class$ = cljs.core.nth.call(null,vec__5489,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__5491 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__5491,(0),null);var id_class = cljs.core.nth.call(null,vec__5491,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj5495 = {};(obj5495[reagent.impl.util.cljs_argv] = v);
(obj5495[reagent.impl.util.cljs_level] = level);
return obj5495;
})();var k_5496 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__5497 = (((k_5496 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_5496);if((k_SINGLEQUOTE__5497 == null))
{} else
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4400__auto___5498 = a.length;var i_5499 = (0);while(true){
if((i_5499 < n__4400__auto___5498))
{(a[i_5499] = reagent.impl.template.as_component.call(null,(a[i_5499]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4400__auto___5501 = a.length;var i_5502 = (0);while(true){
if((i_5502 < n__4400__auto___5501))
{if((i_5502 >= first_child))
{(a[i_5502] = reagent.impl.template.as_component.call(null,(a[i_5502]),level));
} else
{}
{
