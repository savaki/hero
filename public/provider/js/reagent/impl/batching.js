...
reagent.impl.batching.next_tick = ((cljs.core.not(reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__3544__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__3544__auto__))
...
{var C_5470 = (a[i]);if(cljs.core.truth_(C_5470.cljsIsDirty))
{C_5470.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4111__auto__,writer__4112__auto__,opt__4113__auto__){return cljs.core._write(writer__4112__auto__,"reagent.impl.batching/RenderQueue");
});
...
{C.cljsRatom = reagent.ratom.make_reaction.cljs$core$IFn$_invoke$arity$variadic(run,cljs.core.array_seq([cljs.core.constant$keyword$49,((function (res,derefed,rat){
return (function (){return reagent.impl.batching.queue_render(C);
});})(res,derefed,rat))
,cljs.core.constant$keyword$46,derefed], 0));
} else
{}
return res;
} else
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_5472 = C.cljsRatom;if(!((ratom_5472 == null)))
{reagent.ratom.dispose_BANG_(ratom_5472);
} else
{}
