...
{var name_str = cljs.core.name(dashed);var vec__5599 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5599,(0),null);var parts = cljs.core.nthnext(vec__5599,(1));if(cljs.core.truth_((reagent.impl.util.dont_camel_case.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.util.dont_camel_case.cljs$core$IFn$_invoke$arity$1(start) : reagent.impl.util.dont_camel_case.call(null,start))))
{return name_str;
} else
...
{return cljs.core.native_satisfies_QMARK_(cljs.core.IMultiFn,G__5610);
} else
{return false;
}
}
