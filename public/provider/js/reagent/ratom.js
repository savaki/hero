...
reagent.ratom.RAtom.cljs$lang$ctorPrWriter = (function (this__4111__auto__,writer__4112__auto__,opt__4113__auto__){return cljs.core._write(writer__4112__auto__,"reagent.ratom/RAtom");
});
...
var G__5509__delegate = function (x,p__5506){var map__5508 = p__5506;var map__5508__$1 = ((cljs.core.seq_QMARK_(map__5508))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5508):map__5508);var validator = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5508__$1,cljs.core.constant$keyword$9);var meta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5508__$1,cljs.core.constant$keyword$3);return (new reagent.ratom.RAtom(x,meta,validator,null));
};
...
reagent.ratom.Reaction.cljs$lang$ctorPrWriter = (function (this__4111__auto__,writer__4112__auto__,opt__4113__auto__){return cljs.core._write(writer__4112__auto__,"reagent.ratom/Reaction");
});
...
var this$__$1 = this;var seq__5517_5529 = cljs.core.seq(derefed);var chunk__5518_5530 = null;var count__5519_5531 = (0);var i__5520_5532 = (0);while(true){
if((i__5520_5532 < count__5519_5531))
{var w_5533 = chunk__5518_5530.cljs$core$IIndexed$_nth$arity$2(null,i__5520_5532);if(cljs.core.contains_QMARK_(self__.watching,w_5533))
{} else
{cljs.core.add_watch(w_5533,this$__$1,reagent.ratom._handle_change);
}
{
...
{var temp__4126__auto___5538 = cljs.core.seq(seq__5517_5529);if(temp__4126__auto___5538)
{var seq__5517_5539__$1 = temp__4126__auto___5538;if(cljs.core.chunked_seq_QMARK_(seq__5517_5539__$1))
{var c__4300__auto___5540 = cljs.core.chunk_first(seq__5517_5539__$1);{
var G__5541 = cljs.core.chunk_rest(seq__5517_5539__$1);
var G__5542 = c__4300__auto___5540;
var G__5543 = cljs.core.count(c__4300__auto___5540);
var G__5544 = (0);
...
{var w_5545 = cljs.core.first(seq__5517_5539__$1);if(cljs.core.contains_QMARK_(self__.watching,w_5545))
{} else
{cljs.core.add_watch(w_5545,this$__$1,reagent.ratom._handle_change);
}
{
var G__5546 = cljs.core.next(seq__5517_5539__$1);
var G__5547 = null;
var G__5548 = (0);
var G__5549 = (0);
...
var seq__5521_5550 = cljs.core.seq(self__.watching);var chunk__5522_5551 = null;var count__5523_5552 = (0);var i__5524_5553 = (0);while(true){
if((i__5524_5553 < count__5523_5552))
{var w_5554 = chunk__5522_5551.cljs$core$IIndexed$_nth$arity$2(null,i__5524_5553);if(cljs.core.contains_QMARK_(derefed,w_5554))
{} else
{cljs.core.remove_watch(w_5554,this$__$1);
}
{
...
{var temp__4126__auto___5559 = cljs.core.seq(seq__5521_5550);if(temp__4126__auto___5559)
{var seq__5521_5560__$1 = temp__4126__auto___5559;if(cljs.core.chunked_seq_QMARK_(seq__5521_5560__$1))
{var c__4300__auto___5561 = cljs.core.chunk_first(seq__5521_5560__$1);{
var G__5562 = cljs.core.chunk_rest(seq__5521_5560__$1);
var G__5563 = c__4300__auto___5561;
var G__5564 = cljs.core.count(c__4300__auto___5561);
var G__5565 = (0);
...
{var w_5566 = cljs.core.first(seq__5521_5560__$1);if(cljs.core.contains_QMARK_(derefed,w_5566))
{} else
{cljs.core.remove_watch(w_5566,this$__$1);
}
{
var G__5567 = cljs.core.next(seq__5521_5560__$1);
var G__5568 = null;
var G__5569 = (0);
var G__5570 = (0);
...
var this$__$1 = this;var seq__5525_5571 = cljs.core.seq(self__.watching);var chunk__5526_5572 = null;var count__5527_5573 = (0);var i__5528_5574 = (0);while(true){
if((i__5528_5574 < count__5527_5573))
{var w_5575 = chunk__5526_5572.cljs$core$IIndexed$_nth$arity$2(null,i__5528_5574);cljs.core.remove_watch(w_5575,this$__$1);
{
...
{var temp__4126__auto___5580 = cljs.core.seq(seq__5525_5571);if(temp__4126__auto___5580)
{var seq__5525_5581__$1 = temp__4126__auto___5580;if(cljs.core.chunked_seq_QMARK_(seq__5525_5581__$1))
{var c__4300__auto___5582 = cljs.core.chunk_first(seq__5525_5581__$1);{
var G__5583 = cljs.core.chunk_rest(seq__5525_5581__$1);
var G__5584 = c__4300__auto___5582;
var G__5585 = cljs.core.count(c__4300__auto___5582);
var G__5586 = (0);
...
{var w_5587 = cljs.core.first(seq__5525_5581__$1);cljs.core.remove_watch(w_5587,this$__$1);
{
var G__5588 = cljs.core.next(seq__5525_5581__$1);
var G__5589 = null;
var G__5590 = (0);
var G__5591 = (0);
...
var this$__$1 = this;if(cljs.core.not((function (){var or__3544__auto__ = self__.auto_run;if(cljs.core.truth_(or__3544__auto__))
{return or__3544__auto__;
} else
{return reagent.ratom._STAR_ratom_context_STAR_;
}
})()))
{var x__5124__auto___5592 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [self__.auto_run,reagent.ratom._STAR_ratom_context_STAR_], null);if(!((console.log == null)))
{console.log((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(("dbg reagent.ratom:"+177+": [auto-run *ratom-context*]: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([x__5124__auto___5592], 0)))))));
} else
{}
} else
{}
...
var make_reaction__delegate = function (f,p__5593){var map__5595 = p__5593;var map__5595__$1 = ((cljs.core.seq_QMARK_(map__5595))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5595):map__5595);var derefed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5595__$1,cljs.core.constant$keyword$46);var on_dispose = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5595__$1,cljs.core.constant$keyword$47);var on_set = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5595__$1,cljs.core.constant$keyword$48);var auto_run = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5595__$1,cljs.core.constant$keyword$49);var runner = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(auto_run,true))?reagent.ratom.run:auto_run);var active = !((derefed == null));var dirty = !(active);var reaction = (new reagent.ratom.Reaction(f,null,dirty,active,null,cljs.core.PersistentArrayMap.EMPTY,runner,on_set,on_dispose));if((derefed == null))
{} else
{if(cljs.core.truth_(reagent.ratom.debug))
{cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(reagent.ratom._running,cljs.core.inc);
} else
